...
`,e.jsx(a,{demo:e.jsx(o,{}),files:[{path:"demo.tsx",className:"language-tsx",content:p}]})]})}function ie(n={}){const{wrapper:t}={...l(),...n.components};return t?e.jsx(t,{...n,children:e.jsx(i,{...n})}):i(n)}function r(n,t){throw new Error("Expected "+(t?"component":"object")+" `"+n+"` to be defined: you likely forgot to import, pass, or provide it.")}export{ie as default};
